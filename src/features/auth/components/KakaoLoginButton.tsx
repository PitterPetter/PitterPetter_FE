...
export const KakaoLoginButton = () => {
  return (
    <div>
      <Button variant="outlined" className="w-[160px] text-sm text-gray-500" onClick={() => window.location.href = `${import.meta.env.VITE_API_BASE_URL}/oauth2/authorization/kakao`}>
