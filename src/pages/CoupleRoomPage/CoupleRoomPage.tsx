  ...
  return (
    <div className="flex items-center justify-center w-full h-full">
      <div className="h-[700px] w-[700px] bg-white border-gray-300 border rounded-2xl p-4 pb-6 flex flex-col gap-4 justify-center items-center">
        ...
        {/* navigation buttons */}
        <Button variant="contained" onClick={() => navigate('/home/coupleroom/create')}>커플 방 생성</Button>
        <Button variant="contained" onClick={() => navigate('/home/coupleroom/enter')}>커플 방 입장</Button>
      </div>
    </div>
  );
};