        ...
        {(preview || existingImageUrl) ? (
          <div className="relative group">
            <img
              ...
              alt="미리보기"
              className="max-w-full max-h-full mx-auto rounded-lg object-cover shadow-md transition-all duration-200 group-hover:shadow-lg"
            />
            <button
              type="button"
              onClick={handleRemove}
              className="absolute -top-3 -right-3 w-12 h-8 bg-third text-white rounded-lg flex items-center justify-center hover:bg-primary transition-all duration-200 shadow-lg hover:shadow-xl border-2 border-white z-10"
            >
              삭제
            </button>
